...
$('#color option:contains("JS Puns")').addClass('jsPuns');
   $('#color option').not(':contains("JS Puns")').addClass('theHeart');
   //this adds a class to the options including JS Puns and another class for the ones without.

   $('#colors-js-puns').hide(); // This basically hides all elemnts with in the div id of colors-js-puns.
   //shirt choice - show only available shirt colors for the chosen theme/design
   $('#design').change((elem) => {
      $('#colors-js-puns').show();
      //This allows the color options to appear when the element of design is altered.
